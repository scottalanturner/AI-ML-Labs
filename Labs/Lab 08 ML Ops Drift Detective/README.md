# Drift Detective — AURORA‑QR (2025)

Interactive, no‑code lab to learn how to spot and respond to data drift in an ML Ops context using a simulated cybersecurity scenario (QR‑code phishing).
...
2. Click “Explain Change” to see which signals moved most.
3. Choose a playbook action and record your decision in the log.
